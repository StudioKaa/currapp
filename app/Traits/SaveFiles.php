...
trait SaveFiles{
	...
	public function save_files($request, $review)
    {
        ...
        if($request->hasFile('wv_file'))
        {
            ...
            $review->wv_do_path = Storage::disk('spaces')->putFileAs($main_folder . '/reviews', request()->wv_file, $wv_do, 'private');
        }
        ...
        if($request->hasFile('tv_file'))
        {
            ...
            $review->tv_do_path = Storage::disk('spaces')->putFileAs($main_folder . '/reviews', request()->tv_file, $tv_do, 'private');
        }
        ...
        if($request->hasFile('sv_file'))
        {
            ...
            $review->sv_do_path = Storage::disk('spaces')->putFileAs($main_folder . '/reviews', request()->sv_file, $sv_do, 'private');
        }
